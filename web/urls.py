...
urlpatterns = [
    ...
    url(r'^users/invites/create/$', views.user_invite_create, name='users_invite_create'),
    url(r'^users/invites/delete/(?P<code>[a-fA-F0-9]+)/$', views.user_invite_delete, name='users_invite_delete'),
